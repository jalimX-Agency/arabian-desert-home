export const fr: Record<string, unknown> = {
  ...
  booking2: {
    ...
    estimatedTotal: "Estimation du total",
    ...
    addItemsTitle: "Composez votre séjour",
    addItemsDesc: "Ajoutez une ou plusieurs prestations à votre réservation — tentes, activités, Day Pass.",
    addToCart: "Ajouter au panier",
    cartTitle: "Votre panier",
    cartEmpty: "Aucune prestation ajoutée pour l'instant.",
    cartRequiredNote: "Ajoutez au moins une prestation pour continuer.",
    removeItem: "Retirer",
