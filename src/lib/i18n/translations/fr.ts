export const fr: Record<string, unknown> = {
  ...
  // Navigation — "Découvrir" dropdown descriptions
  navMenu: {
    activitiesDesc: "Dromadaire, quad, équitation",
    experiencesDesc: "Journées & soirées tout compris",
    dayPassDesc: "Piscine, déjeuner & dîner",
    restaurantDesc: "Cuisine marocaine sous les étoiles",
    eventsDesc: "Mariages & privatisations",
  },
  ...
  booking2: {
    heroLabel: "Réservation",
    heroTitle1: "Réservez votre",
    heroTitle2: "séjour",
    stepService: "Service",
    stepDetails: "Détails",
    stepInfo: "Vos infos",
    chooseExperienceTitle: "Choisissez votre expérience",
    chooseExperienceDesc: "Sélectionnez le type de séjour que vous souhaitez réserver.",
    serviceTypeTentTitle: "Tentes & Suites",
    serviceTypeTentDesc: "Nuit sous les étoiles",
    serviceTypeActivityTitle: "Activités",
    serviceTypeActivityDesc: "Quad, équitation, dromadaire",
    serviceTypeDayPassDesc: "Piscine, déjeuner, soirée",
    serviceTypeSuiteLabel: "Tente & Suite",
    serviceTypeActivityLabel: "Activité",
    continue: "Continuer",
    back: "Retour",
    yourInfoTitle: "Vos informations",
    yourInfoDesc: "Nous utilisons ces informations pour vous envoyer la confirmation.",
    firstName: "Prénom",
    firstNamePlaceholder: "Jean",
    lastName: "Nom",
    lastNamePlaceholder: "Dupont",
    phone: "Téléphone",
    bookingDetailsTitle: "Détails de votre réservation",
    bookingDetailsDesc: "Choisissez votre prestation, vos dates et le nombre de voyageurs.",
    chooseTent: "Choisissez votre tente",
    multiTentNote: "Vous pouvez choisir plusieurs types de tentes, avec une quantité pour chacune.",
    chooseActivity: "Choisissez votre activité",
    chooseDayPass: "Choisissez votre Day Pass",
    perNight: "/nuit",
    perPerson: "/pers.",
    wholeTent: "tente entière",
    checkIn: "Arrivée",
    checkOut: "Départ",
    ...
    maxGuestsPrefix: "max.",
    maxAdultsWord: "adultes",
    maxChildrenWord: "enfants",
    tentPriceFixedNote: "Le prix de la tente est fixe — le nombre de voyageurs n'affecte pas le total.",
    adults: "Adultes",
    children: "Enfants",
    specialRequests: "Demandes spéciales",
    specialRequestsOptional: "(optionnel)",
    specialRequestsPlaceholder: "Régime alimentaire, préférences, occasion spéciale…",
    sendRequest: "Envoyer ma demande",
    sending: "Envoi…",
    errorTitle: "Une erreur est survenue",
    errorDesc: "Veuillez réessayer.",
    thankYouTitle: "Merci !",
    thankYouDesc: "Votre demande a bien été reçue. Notre équipe vous contactera sous 24h pour confirmer les détails.",
    summary: "Résumé",
    ...
    reviewDesc: "Un email de confirmation avec un lien de gestion vous sera envoyé.",
  ...
  evenements: {
    ...
    heroImageAlt: "Événements de luxe au désert d'Agafay — Mariages & Galas",
  ...
  about: {
    ...
    heroImageAlt: "Arabian Desert Home — Tentes de luxe Agafay",
    heroAerialImageAlt: "Vue aérienne Arabian Desert Home — Désert Agafay",
  ...
  dayPass: {
    ...
    faqTitle2: "Day Pass",
    faqQ1: "Combien de temps dure le Day Pass ?",
    faqA1: "Le Day Pass est valable de 11h à 16h, vous permettant de profiter pleinement de la piscine, du déjeuner et des activités en une journée.",
    faqQ2: "Le prix inclut-il le déjeuner ?",
    faqA2: "Oui, un déjeuner marocain complet est inclus dans toutes les formules Day Pass, ainsi que l'accès à la piscine et aux espaces détente.",
    faqQ3: "Y a-t-il une réduction pour les enfants ?",
    faqA3: "Oui, les enfants bénéficient de -50% sur toutes les formules Day Pass.",
    faqQ4: "Faut-il réserver à l'avance ?",
    faqA4: "Oui, la réservation au moins 24h à l'avance est requise pour garantir votre place, surtout le week-end et en haute saison.",
    faqQ5: "Le transfert depuis Marrakech est-il inclus ?",
    faqA5: "Le transfert peut être organisé sur demande lors de la réservation ; comptez environ 30 à 45 minutes depuis le centre de Marrakech.",
  },
