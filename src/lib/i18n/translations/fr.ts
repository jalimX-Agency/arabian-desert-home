export const fr: Record<string, unknown> = {
  ...
  about: {
    ...
    storyParagraph1: "Niché entre les dunes dorées du désert d'Agafay et la vue imprenable sur les montagnes de l'Atlas, notre hôtel offre une expérience unique et authentique à quelques kilomètres de Marrakech.",
    storyParagraph2: "Notre établissement est bien plus qu'un simple lieu de séjour — c'est une immersion dans la culture marocaine, un havre de paix où luxe, nature et tranquillité se rencontrent.",
