...
export const metadata = {
  ...
  description:
    "The Agafay desert: a stone plateau just 30 minutes from Marrakech — no 9-hour drive to Merzouga. Prices from €35, weather, activities and luxury bivouacs — full 2026 guide.",
  keywords: [
