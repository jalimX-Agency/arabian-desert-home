  ...
  return (
    <div className="p-8 max-w-lg">
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-6">
        <h2 className="text-sm font-semibold text-white mb-1">Compte admin</h2>
        <p className="text-sm text-white/40">{session?.user?.email}</p>
      </div>

      <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
        <h2 className="text-sm font-semibold text-white mb-6">Changer le mot de passe</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs text-white/50 uppercase tracking-widest mb-1.5">Mot de passe actuel</label>
            <input
              type="password"
              value={current}
          ...
          <div>
            <label className="block text-xs text-white/50 uppercase tracking-widest mb-1.5">Nouveau mot de passe</label>
            <input
              type="password"
              value={newPwd}
          ...
          <div>
            <label className="block text-xs text-white/50 uppercase tracking-widest mb-1.5">Confirmer le mot de passe</label>
            <input
              type="password"
              value={confirm}
