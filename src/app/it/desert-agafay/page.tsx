...
export const metadata = {
  ...
  description:
    "Il deserto di Agafay: un altopiano di pietra a soli 30 min da Marrakech, senza le 9 ore di strada per Merzouga. Prezzi da 35 €, meteo, attività e bivacchi di lusso — guida 2026.",
  keywords: [
