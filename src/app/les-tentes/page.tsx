        ...
        <section className="py-20 md:py-28 px-6 md:px-10 bg-charcoal dark:bg-charcoal text-center">
          ...
          >
            ...
            <Link
              ...
              className="inline-flex items-center gap-3 border border-gold/50 text-gold px-10 py-4 text-luxury-label hover:bg-gold/10 transition-all duration-300"
            >
              Réserver Maintenant
    ...
    >
      <Link href={`/${suite.slug}`} className="block">
        ...
        <div className="relative overflow-hidden aspect-[4/5] md:aspect-[3/4]">
          ...
          {/* Top Badge */}
          {suite.featured && (
            <div className="absolute top-4 left-4 flex items-center gap-1.5 bg-gold/90 text-charcoal px-3 py-1.5">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
            ...
            {/* Name & Tagline */}
            <h3 className="font-serif text-2xl md:text-3xl text-white mb-1.5">
              {suite.name}
            </h3>
            <p className="text-sm text-gold/80 mb-3 italic font-serif">
              {suite.tagline}
            </p>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="flex items-center gap-2 text-gold text-sm group-hover:gap-3 transition-all duration-300">
                Voir la suite
