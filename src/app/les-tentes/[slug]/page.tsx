...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description: suite.description,
      url: `https://arabiandeserthome.ma/les-tentes/${slug}`,
    ...
    alternates: { canonical: `https://arabiandeserthome.ma/les-tentes/${slug}` },
  };
}
...
export default async function TenteDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Hébergements", item: "https://arabiandeserthome.ma/les-tentes" },
      { "@type": "ListItem", position: 3, name: suite.name, item: `https://arabiandeserthome.ma/les-tentes/${slug}` },
    ],
  };
