...
const FALLBACK_ACTIVITIES: Activity[] = [
  {
    ...
    description: "Explorez les paysages lunaires du désert d'Agafay à cheval, guidé par nos cavaliers expérimentés.",
    descriptionEn: "",
    longDescription: "Une promenade à cheval au cœur des pierres et des dunes, avec vue sur l'Atlas enneigé.",
    duration: "45 minutes",
    price: 200,
    currency: "MAD",
    image: "https://pub-1d9eaf01e84e452a968f82e2aed10777.r2.dev/activities/activity-horse.png",
    category: "Activité",
    includes: "Guide accompagnateur, Équipement de sécurité, Assurance",
    includesEn: "",
    schedule: "Tous les jours au coucher du soleil",
  ...
  },
  {
    ...
    nameEn: "",
    slug: "raid-quad",
    description: "Vivez une adrénaline pure sur les pistes du désert d'Agafay en quad, encadré par nos moniteurs certifiés.",
    descriptionEn: "",
    longDescription: "Montées rocheuses, passages en oued à sec et fonds de vallées — partez à l'aventure sur des pistes variées.",
    duration: "1 heure",
    price: 400,
    currency: "MAD",
    image: "https://pub-1d9eaf01e84e452a968f82e2aed10777.r2.dev/activities/activity-quad.png",
    category: "Activité",
    includes: "Quad + casque fournis, Moniteur certifié, Assurance",
    includesEn: "",
    schedule: "Tous les jours matin et après-midi",
    transportIncluded: false,
    order: 2,
    featured: true,
  },
  {
    ...
    description: "Revivez les caravanes d'antan lors d'une balade apaisante à dos de dromadaire dans le désert.",
    descriptionEn: "",
    longDescription: "Une expérience douce et mémorable pour petits et grands.",
    duration: "30 minutes",
    price: 150,
    currency: "MAD",
    image: "https://pub-1d9eaf01e84e452a968f82e2aed10777.r2.dev/activities/activity-camel.png",
    category: "Activité",
    includes: "Dromadaire équipé, Guide accompagnateur",
    includesEn: "",
  ...
  },
  {
    ...
    description: "Contemplez le coucher de soleil sur les dunes d'Agafay, suivi d'un dîner sous les étoiles.",
    descriptionEn: "",
    longDescription: "Une soirée magique qui débute par une promenade en dromadaire au crépuscule, puis se prolonge autour d'un feu de camp.",
    duration: "Demi-journée (5h)",
    price: 700,
    currency: "MAD",
    image: "https://pub-1d9eaf01e84e452a968f82e2aed10777.r2.dev/gallery/night.png",
    category: "Expérience",
    includes: "Transport depuis Marrakech, Dromadaire, Feu de camp, Dîner traditionnel, Musique live",
    includesEn: "",
  ...
  {
    id: "journee-authentique",
    name: "Journée Authentique",
    nameEn: "",
    slug: "journee-authentique",
    description: "Une journée complète d'immersion dans la vie du désert entre activités et gastronomie.",
    descriptionEn: "",
    longDescription: "Déjeuner gastronomique, activités, découverte du camp, piscine et détente au coucher du soleil.",
    duration: "Journée complète (9h–18h)",
    price: 550,
    currency: "MAD",
    image: "https://pub-1d9eaf01e84e452a968f82e2aed10777.r2.dev/suites/about.png",
    category: "Expérience",
    includes: "Transport depuis Marrakech, Déjeuner gastronomique, 1 activité au choix, Accès piscine",
    includesEn: "",
    schedule: "Tous les jours",
    transportIncluded: true,
    order: 5,
  ...
  {
    id: "aventure-agafay",
    name: "Aventure Agafay",
    nameEn: "",
    slug: "aventure-agafay",
    description: "Le forfait aventure ultime : quad, équitation, dromadaire et nuit sous les étoiles en tente de luxe.",
    descriptionEn: "",
    longDescription: "L'expérience complète du désert en un seul forfait. Raid quad le matin, déjeuner, balade équestre, dîner sous les étoiles.",
    duration: "24h (arrivée 10h, départ 12h)",
    price: 850,
    currency: "MAD",
    image: "https://pub-1d9eaf01e84e452a968f82e2aed10777.r2.dev/activities/exp-camel.png",
    category: "Aventure",
    includes: "Transport depuis Marrakech, Raid quad, Randonnée équestre, Dromadaire, Dîner & petit-déjeuner, Nuit en tente",
    includesEn: "",
...
export function LesActivitesContent({ activities }: { activities: Activity[] }) {
  ...
  const data = activities.length > 0 ? activities : FALLBACK_ACTIVITIES;
