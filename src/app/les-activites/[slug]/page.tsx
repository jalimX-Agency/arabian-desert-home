...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description: activity.description,
      url: `https://arabiandeserthome.com/les-activites/${slug}`,
    ...
    alternates: { canonical: `https://arabiandeserthome.com/les-activites/${slug}` },
  };
}
...
export default async function ActiviteDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Activités", item: "https://arabiandeserthome.com/les-activites" },
      { "@type": "ListItem", position: 3, name: activity.name, item: `https://arabiandeserthome.com/les-activites/${slug}` },
    ],
  };
